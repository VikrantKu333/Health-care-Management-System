...
JButton b1,b2;
JTable tabel; 
    String x[] = {"PATIENTID","PATIENTNAME","AGE","BLOODGROUP","DISEASES","DOA","CONATCTNO"};
    String y[][] = new String[20][7];
    int i=0, j=0;
PatientS()
{
jf=new JFrame("PATIENT_Search");
l1=new JLabel("Enter the PATIENT_id");
...
{	
	if(ae.getSource()==b1)
	{
		 try{
            conn c1  = new conn();
            String s1 = "select * from PATIENT where PATIENTID='"+t1.getText()+"'";
